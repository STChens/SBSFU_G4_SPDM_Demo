...
#define SE_KEY_REGION_ROM_END               (SE_KEY_REGION_ROM_START + 0x11FF)    /* PCROP protection : Minimum size is 4608 bytes */ 
...
#define SE_CODE_REGION_ROM_END              0x0800BFFF
...
#define SE_REGION_RAM_START               0x20014000
#define SE_REGION_RAM_STACK_TOP           0x20014400
#define SE_REGION_RAM_END                 0x20019FFF
