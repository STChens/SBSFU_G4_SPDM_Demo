...
/* swap  (8 kbytes) */
#define SWAP_START                   0x08048000
#define SWAP_END                     0x08049FFF

/* Active slot #1  (208 kbytes) */
#define SLOT_ACTIVE_1_START          0x08013000
#define SLOT_ACTIVE_1_END            0x08046FFF
#define SLOT_ACTIVE_1_HEADER         SLOT_ACTIVE_1_START

/* Dwl slot #1  (208 kbytes) */
#define SLOT_DWL_1_START             0x0804A000
