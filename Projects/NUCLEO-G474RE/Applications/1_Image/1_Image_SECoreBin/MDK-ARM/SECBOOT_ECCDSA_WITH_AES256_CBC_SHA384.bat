...
set "oemkey=%SBSFUBootLoader%\\1_Image_SECoreBin\\Binary\\OEM_KEY_COMPANY%fwid%_key_AES256_CBC.bin"
set "ecckey=%SBSFUBootLoader%\\1_Image_SECoreBin\\Binary\\ECCKEY%fwid%-384.txt"
