...
/**
  ...
  */ 
#define SECBOOT_CRYPTO_SCHEME SECBOOT_ECCDSA_WITH_AES256_CBC_SHA384 /*!< Selected Crypto Scheme */
...
#define SECBOOT_ECCDSA_WITHOUT_ENCRYPT_SHA384        (4U) /*!< asymmetric crypto, no FW encryption           */
#define SECBOOT_ECCDSA_WITH_AES256_CBC_SHA384        (5U) /*!< asymmetric crypto with encrypted Firmware     */
  
#if ( (SECBOOT_CRYPTO_SCHEME == SECBOOT_ECCDSA_WITH_AES256_CBC_SHA384) || (SECBOOT_CRYPTO_SCHEME == SECBOOT_ECCDSA_WITHOUT_ENCRYPT_SHA384) )
#if defined KEY_REVOCATION
#define KEY_IDX_MAX 7
    /* Comment out the following defnition to use the real key index value from OTP */
